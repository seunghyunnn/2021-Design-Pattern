...
public class ControllableDynamicEntity<T extends DynamicEntity> extends DynamicEntity{
    ...
    public Prototype clone(){
        ControllableDynamicEntity temp  = new ControllableDynamicEntity(
                (DynamicEntity) this.entity.clone(),
    ...
    public void setStrategyLevel(Level level){
        this.entity.setStrategyLevel(level);
    }

    public void setStrategyHero(DynamicEntity hero){
        this.entity.setStrategyHero(hero);
    }
}
