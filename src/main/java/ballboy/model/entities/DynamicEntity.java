...
public abstract class DynamicEntity implements Entity{
    ...
    /**
     * Returns the color of this dynamic entity.
     * @return The color of the dynamic entity "R" for red, "G" for green, "B" for blue, "O" for others.
     */
    public abstract String getColor();

    public abstract Prototype clone();

    public abstract void setStrategyLevel(Level level);

    /**
     * Set the hero that will be used in some strategies of some dynamic entities.
     * @param hero The Dynamic Entity that represents ballBoy in the current level
     */
    public abstract void setStrategyHero(DynamicEntity hero);
}
