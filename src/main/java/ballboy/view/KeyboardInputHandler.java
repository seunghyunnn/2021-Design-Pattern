...
/**
 * The class that handles the keyboard input of the game
 */
...
//        sounds.put("jump", mediaPlayer);
    ...
    void handlePressed(KeyEvent keyEvent) {
        ...
        if (keyEvent.getCode().equals(KeyCode.Q)){ //load
            this.caretaker.setMemento();
        }
        if (keyEvent.getCode().equals(KeyCode.S)){ //save
            this.caretaker.createMemento();
        }
